<?php
if ( ! class_exists( 'TwitchPress_Login_Kraken' ) ) :

    class TwitchPress_Login_Kraken {
        /**
         * @var Singleton
         */
        ...
        */
        ...
        function enqueue_public_css() {
            ...
            wp_register_style( 'twitchpress-login-extension-public-styles', TwitchPress_Login_Kraken::plugin_url() . '/assets/css/public.css' );            
            wp_enqueue_style( 'twitchpress-login-extension-public-styles', TwitchPress_Login_Kraken::plugin_url() . '/assets/css/public.css' ); 
        }
        ...
        */
        public function twitchpress_login_styles() {
            ...
            wp_register_style( 'twitchpress_login_extension_styles', TwitchPress_Login_Kraken::plugin_url() . '/assets/css/public.css' );
...
if( !function_exists( 'TwitchPress_UM_Ext' ) ) {
    ...
    function TwitchPress_Login_Ext() {        
        return TwitchPress_Login_Kraken::instance();
    }
...
register_activation_hook( __FILE__, array( 'TwitchPress_Login_Kraken', 'install' ) );
register_deactivation_hook( __FILE__, array( 'TwitchPress_Login_Kraken', 'deactivate' ) );
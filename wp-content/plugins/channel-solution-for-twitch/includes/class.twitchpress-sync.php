...
class TwitchPress_Systematic_Syncing {
    ...
    */
    ...
    public function init() {
        ...
        // Filters
        add_filter( 'twitchpress_get_sections_kraken', array( $this, 'settings_add_section_kraken' ), 1 );
        add_filter( 'twitchpress_get_settings_kraken', array( $this, 'settings_add_options_kraken' ), 1 );

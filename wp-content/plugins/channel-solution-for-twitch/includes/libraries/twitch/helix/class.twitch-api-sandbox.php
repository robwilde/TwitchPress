<?php
/**
 * Twitch API Sandbox (Version 6 - Helix) 
 * 
 * Designed for WordPress and the TwitchPress system to be easy to understand
 * and modify, hope you enjoy working with it!
 * 
 * @author Ryan Bayne
 * @version 6.0
 */
...
class TwitchPress_Twitch_API {
    ...
    */
    ...
    public function request_app_access_token( $requesting_function = null ){
        ...
        $this->curl_object->endpoint = 'https://api.twitch.tv/helix/oauth2/token?client_id=' . twitchpress_get_app_id();
    ...
    */
    ...
    public function request_user_access_token( $code = null, $requesting_function = null ){
        ...
        $endpoint = 'https://api.twitch.tv/helix/oauth2/token';
    ...
    */
    public function start_twitch_session_admin( $account = 'main' ) {
        ...
        $state = array( 'redirectto' => admin_url( '/admin.php?page=twitchpress&tab=helix&amp;' . 'section=entermaincredentials' ),
    ...
    */
    ...
    public function addBlockedUser( string $chan, string $username, string $token, string $code){
        ...
        $url = 'https://api.twitch.tv/helix/users/' . $chan . '/blocks/' . $username;
    ...
    public function getStreamObject( $channel_id ){
        $url = 'https://api.twitch.tv/helix/streams/' . $channel_id;
        $get = array( 'client_id' => $this->twitch_client_id );
    ...
    public function get_channel_subscribers( $chan, $limit = -1, $offset = 0, $direction = 'asc', $token = null, $code = null ){
        ...
        {
            $this->bugnet->log_error( __FUNCTION__, __( 'helix5 was not giving sccope channel_subscriptions in the get_channel_subscribers() function.', 'twitchpress' ), array(), true ); 
    ...
    public function getChannelSubscription( $twitch_user_id, $chan_id, $token ){
        ...
        $url = 'https://api.twitch.tv/helix/channels/' . $chan_id . '/subscriptions/' . $twitch_user_id;
    ...
    */
    ...
    public function get_users_subscription_apicall( $twitch_user_id, $chan_id, $user_token = false ){
        ...
        $url = 'https://api.twitch.tv/helix/users/' . $twitch_user_id . '/subscriptions/' . $chan_id;
    ...
    */
    ...
    public function getUserSubscription( $twitch_user_id, $chan_id, $user_token ){   
        ...
        $endpoint = 'https://api.twitch.tv/helix/users/' . $twitch_user_id . '/subscriptions/' . $chan_id;  

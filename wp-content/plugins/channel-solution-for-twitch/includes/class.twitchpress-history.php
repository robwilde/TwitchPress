...
/**
 * TwitchPress Class for storing changes history.
 * 
 * This class does not offer a UI. It is up to extensions to access the changes
 * history and use it as required. 
 * 
